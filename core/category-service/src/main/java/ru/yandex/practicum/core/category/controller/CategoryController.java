package ru.yandex.practicum.core.category.controller;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.http.HttpStatus;
import org.springframework.web.bind.annotation.*;
import ru.yandex.practicum.core.category.service.CategoryService;
...
public class CategoryController {
    ...
    public List<CategoryDto> getCategoryByIds(@RequestParam(name = "categoryIds", required = false)
        ...
        return categoryService.getCategoryByIds(categoryIds);
    }
}
