package ru.yandex.practicum.core.interaction.event.constants;
...
public class EventsConstants {
    ...
    public static final String PUBLIC_API_PREFIX_RECOMMENDATION = "/recommendations";
    public static final String PUBLIC_API_PREFIX_like = "/like";

    public static final String USER_ID = "user-id";
    public static final String EVENT_ID = "event-id";
    public static final String EVENT_ID_PATH = "/{event-id}";

    public static final String INTERACTION_API_PREFIX = "/interaction/events";
    public static final String COUNT = "/count";
    public static final String SHORT_DTO = "/shorts";
